...
// IMPORTANTCOMMENT VANILLA REDUCER

// export const cakeReducer = (state = initialList, action) => {
//   switch (action.type) {
//     case cakeTypes.add:
...
//       console.log(action.payload);
//       return state;
//     case cakeTypes.deleteAll:
//       console.log('delete all func');
//       return state;
//     case cakeTypes.deleteOne:
//       console.log(action.payload);
//       return state;
//     default:
//       return state;
...
// IMPORTANTCOMMENT IMMER REDUCER
export const cakeReducer = (state = initialList, action) => {
  switch (action.type) {
    case cakeTypes.add:
